...
export default function Layout({ children, darkMode, onToggleDarkMode }: LayoutProps) {
  const { refresh, loading, tables, lastRefreshed, toast, clearToast } = useSchema()
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            {lastRefreshed && (
              <span className="text-xs text-gray-400 dark:text-gray-500" title={lastRefreshed.toLocaleString()}>
